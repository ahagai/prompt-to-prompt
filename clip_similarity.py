...
class ClipSimilarity(nn.Module):
    ...
    def forward(
        self, image_0, image_1, text_0: list[str], text_1: list[str]
    ) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]:
        image_features_0 = self.encode_image(self.t(image_0)[None, :])
        image_features_1 = self.encode_image(self.t(image_1)[None, :])
